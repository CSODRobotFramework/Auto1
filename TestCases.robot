...
Open URL Locally
    ...
    Create Webdriver    Chrome    my_alias    chrome_options=${chrome_options}  executable_path=/Users/garyfung/Downloads/chromedriver  #/usr/lib/chromium-browser/chromedriver
